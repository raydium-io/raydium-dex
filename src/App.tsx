    ...
    <Suspense fallback={() => <Spin size="large" />}>
      ...
      <div style={{background: '#9B1DAF', padding: '10px 20px', fontWeight: 'bold' }}>
        <div style={{width: '100%', maxWidth: '750px', margin: '0 auto', lineHeight: '8px'}}>
          <p>This page is a UI implementation that accesses the Project Serum DEX <a style={{color: '#39D0D8'}} href='https://github.com/project-serum/serum-dex'>smart contracts</a>.</p>  
          <p>This trading page will be deprecated on December 14 - Please cancel and settle existing orders.</p> 
